...
{{--                                        <td><?php if (!is_null($purchase->branch)) {echo $company->companyName;}; ?></td>--}}
                                        ...
                                        <td>
                                            ...
                                            <a  class="btn btn-danger btn-sm" id="delete" title="Delete" href="javascript:void(0)" data-url="{{ route('purchaseReturnInfo', $purchase->id) }}" >
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <form action="{{ route('deletePurchaseReturn') }}" class="form-group" method="post" enctype="multipart/form-data">
                        {{csrf_field()}}
